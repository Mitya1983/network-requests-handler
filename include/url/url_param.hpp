...
#ifndef INCLUDE_URL_URL_PARAM_HPP
#define INCLUDE_URL_URL_PARAM_HPP
...
namespace mt::network::url {
    ...
    public:
        UrlParams() = default;
        explicit UrlParams(std::indirectly_readable auto& begin, std::indirectly_readable auto end)
            requires std::is_same_v< std::decay_t< decltype(*begin) >, std::decay_t< decltype(*end) > > or concepts::parse_compatible< std::decay_t< decltype(*begin) > >;
        explicit UrlParams(std::ranges::input_range auto&& range)
        ...
        UrlParams(const UrlParams& p_other) = default;
        UrlParams(UrlParams&& p_other) noexcept = default;
        UrlParams& operator=(const UrlParams& p_other) = default;
        UrlParams& operator=(UrlParams&& p_other) noexcept = default;
        ~UrlParams() = default;
    ...
    UrlParams::UrlParams(std::indirectly_readable auto& begin, std::indirectly_readable auto end)
        requires std::is_same_v< std::decay_t< decltype(*begin) >, std::decay_t< decltype(*end) > > or concepts::parse_compatible< std::decay_t< decltype(*begin) > >
    {
        while (begin != end) {
    ...
    UrlParams::UrlParams(std::ranges::input_range auto&& range)
        requires std::is_same_v< std::decay_t< decltype(*range.begin()) >, std::decay_t< decltype(*range.end()) > >
                 or concepts::parse_compatible< std::decay_t< decltype(*range.begin()) > >
        :
        UrlParams(range.begin(), range.end()) { }

}  // namespace mt::network::url

#endif //INCLUDE_URL_URL_PARAM_HPP
